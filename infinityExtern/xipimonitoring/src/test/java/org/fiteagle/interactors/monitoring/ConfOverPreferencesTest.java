...
//		Assert.assertEquals(Utils.PATH_PORTLET, "/InfinityServices-portlet/json");
...
//		Assert.assertEquals(Utils.timeForTooOldNotAcceptableLastCheckedInMilis, 2880*60*1000);
